...
export async function updateLead(
  id: string,
  updates: Partial<Pick<Lead, 'stage' | 'name' | 'qualification_data' | 'project_interest' | 'last_message_at' | 'bot_active' | 'assigned_to' | 'opted_out' | 'last_proactive_at' | 'last_alert_at'>>
): Promise<void> {
  const supabase = getServiceClient()
